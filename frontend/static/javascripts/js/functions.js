...
(function ($) {
    ...
    SEMICOLON.initialize = {
        ...
        init: function () {
            ...
            $('.content-comite').hide();
            $('#1').show();
            $('#menu-service-menu > li.menu-item').click(function (event) {
                event.preventDefault();
                $('#menu-service-menu > li.menu-item').removeClass('current_page_item');
                $('.content-comite').hide();
        ...
        pageTransition: function () {
            ...
            $wrapper.animsition({
                ...
                linkElement: '#primary-menu:not(.on-click) ul li a:not([aria-label="this opens in a new tab" target="_blank"]):not([href*="#"]):not([data-lightbox]):not([href^="mailto"]):not([href^="tel"]):not([href^="sms"]):not([href^="call"])',
                loading: true,
    ...
    SEMICOLON.header = {
        ...
        menufunctions: function () {
            ...
            $('.top-links ul li:has(ul) > a, #primary-menu.with-arrows > ul > li:has(ul) > a > div, #primary-menu.with-arrows > div > ul > li:has(ul) > a > div, #page-menu nav ul li:has(ul) > a > div').append('<i role="presentation" class="icon-angle-down"></i>');
            ...
            if (SEMICOLON.isMobile.Windows()) {
                ...
                $('#primary-menu ul li:has(ul)').append('<a href="#" class="wn-submenu-trigger"><i role="presentation" class="icon-angle-down"></i></a>');
        ...
        removeStickyness: function () {
            if ($header.hasClass('sticky-header')) {
                ...
                $(".slotholder").attr("style", "position: absolute; top: 0px; left: 0px; z-index: 0; width: 100%; height: 100%; backface-visibility: hidden; transform: translate3d(0px, 0px, 0px); visibility: inherit; opacity: 1;")
            }
        ...
        logo: function () {
            ...
            // 	if( defaultDarkLogo && defaultLogo.find('img').attr('src')!= defaultDarkLogo){ defaultLogo.find('img').attr('src', defaultDarkLogo); }
            // 	if( retinaDarkLogo && retinaLogo.find('img').attr('src')!=retinaDarkLogo){ retinaLogo.find('img').attr('src', retinaDarkLogo); }
            // } else {
            // 	if( defaultLogoImg && defaultLogo.find('img').attr('src') != defaultLogoImg){ defaultLogo.find('img').attr('src', defaultLogoImg); }
            // 	if( retinaLogoImg&& retinaLogo.find('img').attr('src') != retinaLogoImg){ retinaLogo.find('img').attr('src', retinaLogoImg); }
            // }
            // if( $header.hasClass('sticky-header') ) {
            // 	if( defaultStickyLogo &&defaultLogo.find('img').attr('src') != defaultStickyLogo ){ defaultLogo.find('img').attr('src', defaultStickyLogo); }
            // 	if( retinaStickyLogo &&retinaLogo.find('img').attr('src')!= retinaStickyLogo){ retinaLogo.find('img').attr('src', retinaStickyLogo); }
            // }
            // if( $body.hasClass('device-sm') || $body.hasClass('device-xs') ) {
            // 	if( defaultMobileLogo && defaultLogo.find('img').attr('src') != defaultMobileLogo){ defaultLogo.find('img').attr('src', defaultMobileLogo); }
            // 	if( retinaMobileLogo && retinaLogo.find('img').attr('src') != retinaMobileLogo){ retinaLogo.find('img').attr('src', retinaMobileLogo); }
            // }
        },
    ...
    SEMICOLON.widget = {
        ...
        init: function () {
            ...
            SEMICOLON.carouselContainer = SEMICOLON.widget.carousel();
                ...
                $flexSliderEl.each(function () {
                    ...
                    $flexsSlider.flexslider({
                        ...
                        start: function (slider) {
                            ...
                            SEMICOLON.initialize.lightbox();
                            $('.flex-prev').html('<i role="presentation" class="icon-angle-left"></i>');
                            $('.flex-next').html('<i role="presentation" class="icon-angle-right"></i>');
                    ...
                    if (dribbbleType == 'user') {
                        ...
                        $.jribbble.users(dribbbleUsername).shots({
                            ...
                            res.forEach(function (shot) {
                                html.push('<a href="' + shot.html_url + '" aria-label="this opens in a new tab" target="_blank">');
        ...
        navTree: function () {
            ...
            if ($navTreeEl.length > 0) {
                $navTreeEl.each(function () {
                    ...
                    element.find('ul li:has(ul) > a').append(' <i role="presentation" class="icon-angle-down"></i>');
        ...
        carousel: function () {
            ...
            $carousel.each(function () {
                var element = $(this),
                    ...
                    elementAutoHeightClass = element.attr('data-auto-height-class'),
                ...
                carrusels[element.attr("id")] = element.owlCarousel({
                    ...
                    autoHeightClass:elementAutoHeightClass,
                    responsive: {
        ...
        notifications: function (element) {
            ...
            toastr.options.closeHtml = '<button><i role="presentation" class="icon-remove"></i></button>';
                ...
                element.find('form').validate({
                    submitHandler: function (form) {
                        ...
                        if (elementLoader == 'button') {
                            ...
                            defButton.html('<i role="presentation" class="icon-line-loader icon-spin nomargin"></i>');
                        } else {
